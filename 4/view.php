...
<div class="container" >
    ...
    <div>
      <button type="submit" class="btn btn-success" name="submit" id="sub">Submit</button>
    ...
    <script src="../3/css/bootstrap.min2.js"></script>
    <script src="../3/css/jquery-3.6.0.min.js"></script>
    <script>
